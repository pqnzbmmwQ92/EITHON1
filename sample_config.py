...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/pqnzbmmwQ92/EITHON1.git"
    )
    ...
    PMPERMIT_TEXT_EITHON1 = os.environ.get("PMPERMIT_TEXT_EITHON1", None)
    UB_BLACK_LIST_CHAT = {
    ...
    # specify NO_LOAD with plugin names for not loading in EITHON1
