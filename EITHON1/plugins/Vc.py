...
R = [
    ...
    "**-** مطور السورس **⪼ [𐇮 𓂐 للعمل/مٰۭۘـٖۛৣ๋͜͡ﹻٰـحـ᭓͚͊٘͢ـٰ͜͡ـمٰۭٖۘـٖۛৣ๋͜͡ﹻٰـٰډ͢ ༒ آٖب۪ٖؔٛـ࿆ۦ๋ۚۧ͜ـﯡُٖ٘ز۪ۖڰـٖۛৣ๋͜͡ﹻٰـﯡٍ٘ٚࢪٰ۪ؔ༒ ](t.me/TTTLL0)   \n"
...
Citation1_morning = [
    ...
    "** كت تويت | اكثر مطور تحبه ايــثـون منو ؟ **",
