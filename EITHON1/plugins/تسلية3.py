...
from . import EITHON1, edit_delete, edit_or_reply, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m EITHON1`",
        "**State changed from starting to up**",
        "__INFO:EITHON1:Logged in as 557667062__",
        "__INFO:EITHON1:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
