...
autopic_path = os.path.join(os.getcwd(), "EITHON1", "original_pic.png")
digitalpic_path = os.path.join(os.getcwd(), "EITHON1", "digital_pic.png")
autophoto_path = os.path.join(os.getcwd(), "EITHON1", "photo_pfp.png")

digitalpfp = Config.DIGITAL_PIC or "https://telegra.ph/file/22aa9c0c7e5d8a04ceb30.jpg"
...
async def _(event):
    ...
    if gvarstatus("digitalpic") is not None and gvarstatus("digitalpic") == "true":
        return await edit_delete(event, "**الصـورة الـوقتية فعالة بالأصـل 🧸♥**")
...
async def _(event):
    ...
    if gvarstatus("autoname") is not None and gvarstatus("autoname") == "true":
        return await edit_delete(event, "**الاسـم الـوقتي فعال بالأصـل 🧸♥**")
...
async def _(event):
    ...
    if gvarstatus("autobio") is not None and gvarstatus("autobio") == "true":
        return await edit_delete(event, "**الـبايو الـوقتي فعال بالأصـل 🧸♥**")
