...
@EITHON1.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump Catuserbot is One of the Popular EITHON1",
    },
)
...
@EITHON1.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}مودي <نص>",
        "examples": "{tr}مودي ايــثــون الاصلي",
    },
)
async def nekobot(cat):
...
@EITHON1.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catuserbot is One of the Popular EITHON1",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@EITHON1.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna EITHON1 is One of the Popular EITHON1",
    },
)
async def nekobot(cat):
...
@EITHON1.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; EITHON1 is One of the Popular EITHON1",
    },
)
async def nekobot(cat):
